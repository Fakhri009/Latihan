...
<script>
    $(document).ready(function() {
        $('#roles').change(function() {
            ...
            if (kel == "customer") {
                $("#noId").html('<label for="nic">NIC customer</label><input id="nic" type="text" onkeypress="return inputAngka(event)" placeholder="NIC Customer" class="form-control" name="nic" autocomplete="off">');
            } else if (kel == "kapster") {
                $("#noId").html(`<label for="nik">NIK kapster</label><input id="nik" type="text" placeholder="NIK kapster" class="form-control" name="nik" autocomplete="off">`);
            } else if (kel == "admin") {
